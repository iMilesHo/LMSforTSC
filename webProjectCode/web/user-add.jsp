        ...
        <div class="row">
            <div class="col-md-2">
                <div class="list-group">
                    ...
                    <a href="user-search.jsp" class="list-group-item">用户搜索</a>
                    <a role="button" data-toggle="modal" data-target="#myModal" class="list-group-item active">添加用户</a>
                </div>
            </div>
            <div class="col-md-10">
                ...
                <div>
                    ...
                    <form action="#" class="user-search">
                        <div class="alert alert-info" role="alert">
                            <strong>技巧提示：</strong>支持模糊搜索和匹配搜索，匹配搜索请用*来代替。
                        </div>
                        ...
                        <div class="form-group">
                            <lable for="use-group">选择用户组</lable>
                            <select name="" id="use-group" class="form-control">
