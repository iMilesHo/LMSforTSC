        ...
        <div class="row">
            <div class="col-md-2">
                <div class="list-group">
                    <a href="temp_user-list.jsp" class="list-group-item active">用户管理</a>
            ...
            <div class="col-md-10">
                ...
                <div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                        <c:forEach var="U" items="${requestScope.allofUsers}">
                            <tr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="#">
                        ...
                        <div class="form-group">
                            <lable for="add-group">所属用户组</lable>
                            <select name="" id="add-group" class="form-control">
