...
<section id="bootstarp">
    <div class="container">
        <div class="row wow fadeInDown" data-wow-offset="10">
            ...
            <div class="col-md-9">
                <%
                    List<Messages> ALLSentedMessages = (List<Messages>)pageContext.findAttribute("allofSentedMessages");
                    int messageId=1,i=0;
                    for(Messages isentedMessage:ALLSentedMessages){
                        messageId=isentedMessage.getmessageId();
                %>
                <div class="momentPanel">
                    <table width="100%" align="center">
                        <tr>
                            ...
                            <td>&nbsp;&nbsp;&nbsp;</td>
                            <td>
                                <h3>&nbsp;&nbsp;To:&nbsp;&nbsp;<%=isentedMessage.gettousername()%>&nbsp;&nbsp;
                                    <a><%=isentedMessage.getmessageTime()%></a>&nbsp;&nbsp;&nbsp;&nbsp;
                                    <a href="userinfor.jsp">继续分享文献</a></h3>
                                <pre class="content"><%=isentedMessage.getmessageWord()%></pre>
                            <td>
                            <td></td>
                        </tr>
                        <% int havepics=isentedMessage.gethavePicture();
                            if(havepics==1){
                        %>
                        <tr>
                            <td>&nbsp;&nbsp;&nbsp;</td>
                            <th colspan="3">
                                <div class="fakeimg">
                                    <img src="/myimages/<%=isentedMessage.getpictureUrl()%>" class="img-thumbnail" width="50%">
                                </div>
                            </th>
                        </tr>
                        <%} %>
