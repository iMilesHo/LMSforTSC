            ...
            <div class="col-md-9">
                <div class="statisticPanel">
                    <div class="form-container ">
                        <form action="updateUserInforServlet" method="post" enctype="multipart/form-data">
                            <table width="100%" align="center">
                                <tr><td colspan="5">&nbsp;&nbsp;&nbsp;</td></tr>
                                <tr>
                                    <td></td>
                                    <td align="center" colspan="2">
                                        <%User U=(User)pageContext.findAttribute("userinfor");%>
                                        <div class="divhead">
                                            <img src="/myimages/<%=U.getheadUrl()%>" class="img-circle" width="120" height="120">
                                        </div>
                                    </td>
                                    <td></td>
                                    <td></td>
                                ...
                                <tr>
                                    <td></td>
                                    <td colspan="2">
                                        <h2 align="center">个人信息<span class="label label-info">${requestScope.update}${requestScope.Unupdate}</span></h2>
                                    </td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><a>name</a></td>
                                    <td>
                                        <input type="text" readonly value="<%=U.getusername()%>" name="name">
                                        <input type="hidden" name="userId" value="<%=U.getuserId()%>">
                                        <input type="hidden" name="headUrl" value="<%=U.getheadUrl()%>">
                                    </td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><a>password</a></td>
                                    <td>
                                        <input type="password" value="<%=U.getpassword()%>" name="password">
                                    </td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><a>school</a></td>
                                    <td>
                                        <input type="text" value="<%=U.getSchool()%>" name="school">
                                    </td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><a>birthday</a></td>
                                    <td>
                                        <input type="text" value="<%=U.getbirthday()%>" name="birthday">
                                    </td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><a>field</a></td>
                                    <td>
                                        <input type="text" value="<%=U.getfield()%>" name="field">
                                    </td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                <tr>
                                    ...
                                    <td><a>degree</a></td>
                                    <td>
                                        <input type="text" value="<%=U.getdegree()%>" name="degree">
                                    </td>
                                    <td></td>
                                    <td></td>
                                </tr>
